...
public class Bicicleta {
    ...
    public static String rutaCorta(int [] camino1, int [] camino2, int [] camino3){
       ...
       //cada camino puede contener diferente número de tramos, por lo que se recorrerá individualmente cada array
       //para realizar la suma correcta de cada uno de ellos.
